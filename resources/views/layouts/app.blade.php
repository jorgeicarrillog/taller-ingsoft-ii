...
<body>
    ...
    <script src="{{ asset('assets/bootstrap-fileinput/js/fileinput.min.js') }}" defer></script>
    <script src="{{ asset('assets/bootstrap-fileinput/js/locales/es.js') }}" defer></script>
    <script src="{{ asset('assets/bootstrap-fileinput/themes/fa/theme.js') }}" defer></script>
    @yield('scripts')
</body>
</html>
